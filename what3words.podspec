Pod::Spec.new do |s|
  ...
  s.source_files = "Sources/W3WSwiftApi/*.swift", "Sources/W3WSwiftApi/Lib/DataTypes/*.swift", "Sources/W3WSwiftApi/Lib/Network/*.swift", "Sources/W3WSwiftApi/Voice/*.swift"
  s.swift_version = '5.0'
end
