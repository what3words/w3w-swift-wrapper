...
To use this library in your project manually simply drag W3wGeocoder.swift to the project tree
...
Import the module as follows in any swift file you wish to use What3Words:
...
Initialise using the API Key you recieved by signing up to the [website](https://map.what3words.com/register?dev=true).
